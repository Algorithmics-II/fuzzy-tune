...
import org.example.fuzzy_matcher.component.*;
import org.example.fuzzy_matcher.domain.*;
import org.example.fuzzy_matcher.function.*;
...
public class MatchServiceTest {
    ...
    public List<Document> getTestDocuments() throws FileNotFoundException {
        ...
        if (inputStream == null) {
            throw new FileNotFoundException("File not founded: 'test-data.csv'");
        }
    ...
    public List<Document> getDemoDocuments() throws FileNotFoundException {
        InputStream inputStream = getClass().getClassLoader().getResourceAsStream("demo.csv");
        if (inputStream == null) {
            throw new FileNotFoundException("File not founded: 'demo.csv'");
        }
        CSVReader csvReader = new CSVReader(new InputStreamReader(inputStream));
